...
export function getInputClassName(prefixCls, size, disabled) {
  ...
  return classNames(prefixCls, (_classNames = {}, _classNames[prefixCls + "-sm"] = size === 'small', _classNames[prefixCls + "-lg"] = size === 'large', _classNames[prefixCls + "-disabled"] = disabled, _classNames));
}
var props = {
  prefixCls: String,
  inputType: String,
...
var _createNamespace = createNamespace('wrapper'),
...
export default createComponent({
  ...
  methods: {
    ...
    renderLabeledIcon: function renderLabeledIcon(prefixCls, element) {
      ...
      var affixWrapperCls = classNames(props.className, prefixCls + "-affix-wrapper", (_classNames2 = {}, _classNames2[prefixCls + "-affix-wrapper-sm"] = props.size === 'small', _classNames2[prefixCls + "-affix-wrapper-lg"] = props.size === 'large', _classNames2[prefixCls + "-affix-wrapper-input-with-clear-btn"] = props.suffix && props.allowClear && this.$props.value, _classNames2));
      return h("span", {
    ...
    renderInputWithLabel: function renderInputWithLabel(prefixCls, labeledElement) {
      ...
      var mergedWrapperClassName = classNames(prefixCls + "-wrapper", (_classNames3 = {}, _classNames3[wrapperClassName] = addonBefore || addonAfter, _classNames3));
      var mergedGroupClassName = classNames(className, prefixCls + "-group-wrapper", (_classNames4 = {}, _classNames4[prefixCls + "-group-wrapper-sm"] = size === 'small', _classNames4[prefixCls + "-group-wrapper-lg"] = size === 'large', _classNames4)); // Need another wrapper for changing display:table to display:inline-block
